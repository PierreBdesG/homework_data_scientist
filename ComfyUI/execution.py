...
def execute(server, dynprompt, caches, current_item, extra_data, executed, prompt_id, execution_list, pending_subgraph_results):
    ...
    try:
    ...
    except ComfyUI.model_management.InterruptProcessingException as iex:
        ...
        if isinstance(ex, ComfyUI.model_management.OOM_EXCEPTION):
...
class PromptExecutor:
    ...
    def handle_execution_error(self, prompt_id, prompt, current_outputs, executed, error, ex):
        ...
        if isinstance(ex, ComfyUI.model_management.InterruptProcessingException):
            mes = {
                "prompt_id": prompt_id,
                "node_id": node_id,
                "node_type": class_type,
    ...
    def execute(self, prompt, prompt_id, extra_data={}, execute_outputs=[]):
        ...
        with torch.inference_mode():
            ...
            ComfyUI.model_management.cleanup_models(keep_clone_weights_loaded=True)
            ...
            if ComfyUI.model_management.DISABLE_SMART_MEMORY:
                ComfyUI.model_management.unload_all_models()
