...
def get_torch_device():
    ...
    global cpu_state
    cpu_state = CPUState(value=0) if torch.cuda.is_available() else CPUState(value=1)
...
def resolve_lowvram_weight(weight, model, key): #TODO: remove
    print("WARNING: The ComfyUI.model_management.resolve_lowvram_weight function will be removed soon, please stop using it.")
    return weight
