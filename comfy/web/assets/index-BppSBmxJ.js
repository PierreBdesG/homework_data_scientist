...
const ProgressMessages = {
  ...
  [
    "error"
    /* ERROR */
  ]: "Was not able to start comfy. Please check the logs for more details. You can open it from the Help menu. Please report issues to: https://forum.comfy.org"
};
...
const MigrationItems = [
  ...
  },
  {
    id: "models",
    label: "Models",
    description: "Reference model files from existing comfy installations. (No copy)"
  }
  ...
  //   id: 'custom_nodes',
  //   label: 'Custom Nodes',
  //   description: 'Reference custom node files from existing comfy installations. (No copy)',
  // },
];
const DEFAULT_SERVER_ARGS = {
  /** The host to use for the comfy server. */
  host: "127.0.0.1",
  /** The port to use for the comfy server. */
  port: 8e3,
  // Extra arguments to pass to the comfy server.
  extraServerArgs: {}
};
